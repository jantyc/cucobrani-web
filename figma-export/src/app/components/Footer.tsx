    ...
    >
      <div className="max-w-7xl mx-auto px-5 md:px-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
          ...
          <div>
            <div
              ...
              style={{ fontFamily: "'Bebas Neue', sans-serif", color: "#fff", letterSpacing: "0.08em", fontSize: "1.5rem" }}
            >
            ...
            >
              Každoroční satirická soutěž domácích ovocných vín. Od roku 1989.
              Machovsko, Žďár nad Metují.
            </p>
          </div>
          ...
          <div>
            ...
            >
              Fotografie, připomínky,<br />nápady k webu.
            </p>
          </div>
        </div>
        ...
        >
          ...
          >
            © 2025 Čůčobraní · Žďár nad Metují · Machovsko
          </p>
          <p
            style={{
              fontFamily: "'Inter', sans-serif",
          ...
          >
            Akce organizovaná pro radost, nikoli pro zisk 🍷
          </p>
        </div>
      </div>
    </footer>
