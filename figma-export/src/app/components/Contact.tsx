...
const organizers = [
  ...
  {
    name: "Jiří Kača Zocher",
    role: "Mistr banja a člen organizačního výboru",
    emoji: "🪕",
  },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div>
            ...
            >
              ...
              >
                „Čůčobraní je akce organizovaná partou lidí, kteří to dělají pro radost.
                Nikoli jako komerční event."
              </p>
            </div>
          </div>
        </div>
